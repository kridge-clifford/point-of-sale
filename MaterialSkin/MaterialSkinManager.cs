...
namespace MaterialSkin
{
    public class MaterialSkinManager
    {
        ...
        // DEFAULT BLACK COLORED FONT
        //private static readonly Color PRIMARY_TEXT_BLACK = Color.FromArgb(222, 0, 0, 0); 
        private static readonly Color PRIMARY_TEXT_BLACK = Color.FromArgb(14, 53, 81);
        ...
        // Checkbox colors
        private static readonly Color CHECKBOX_OFF_LIGHT = Color.FromArgb(161, 161, 161);
        ...
        {
            ROBOTO_MEDIUM_12 = new Font(LoadFont(Resources.Montserrat_Medium), 12f);
            ROBOTO_MEDIUM_10 = new Font(LoadFont(Resources.Montserrat_Medium), 10f);
            ROBOTO_REGULAR_11 = new Font(LoadFont(Resources.Montserrat_Medium), 11f);
            ROBOTO_MEDIUM_11 = new Font(LoadFont(Resources.Montserrat_Medium), 11f);
			Theme = Themes.LIGHT;
